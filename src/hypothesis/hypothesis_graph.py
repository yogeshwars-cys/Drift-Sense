...
def decide(nodes_sorted, diag, landmark_z_threshold=4.0, belief_threshold=0.20,
           nominal_center=(500.0, 500.0), tie_eps=0.02):
    """Commit, or abstain.
    ...
    landmark channel is not decisive the system says so, returns the
    ...
    return dict(x=top['x'], y=top['y'], abstain=not (identifiable and decisive),
